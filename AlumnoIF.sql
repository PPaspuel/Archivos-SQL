...
/*Condiciones IF*/
SELECT CONCAT_WS(' ',nombre,apellidopaterno,apellidomaterno) AS 'NombreCompleto',
promedio,
IF(promedio >= 80,'Buen Desempenio','Mal Desempenio') AS 'Desempenio'
FROM alumnos;
/*Para establces una condicion especifica usamos la sentencia IF, la cual esta compuest por 
tres parametros el premero es la condicion (IF >= 90), el segundo es el mensaje o instruc-
cion a ejecutarse en canso de que la sentencia se cumpla(Buen Desempenio), la tercera es el
 mensaje o parametro a ejecutarse en caso de que la condicion no aplique (Mal Desempenio)
 El comando CONCAT_WS: Sirve para unir dos o mas campos en uno solo*/
